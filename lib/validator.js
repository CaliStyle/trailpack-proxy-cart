...
module.exports = {
  ...
  validateProduct: {
    ...
    add(data) {
      return new Promise((resolve, reject) => {
        joi.validate(data, lib.Schemas.products.product, (err, value) => {
          if (err) {
            return reject(new Errors.ValidationError(err))
          }
          return resolve(value)
    ...
    addProducts(data) {
      return new Promise((resolve, reject) => {
        joi.validate(data, lib.Schemas.products.add, (err, value) => {
          if (err) {
            return reject(new Errors.ValidationError(err))
          }
          return resolve(value)
    ...
    updateProducts(data) {
      return new Promise((resolve, reject) => {
        joi.validate(data, lib.Schemas.products.update, (err, value) => {
          if (err) {
            return reject(new Errors.ValidationError(err))
          }
          return resolve(value)
    ...
    removeProducts(data) {
      return new Promise((resolve, reject) => {
        joi.validate(data, lib.Schemas.products.remove, (err, value) => {
          if (err) {
            return reject(new Errors.ValidationError(err))
          }
          return resolve(value)
  ...
  validateVariant: {
    create(data) {
      return new Promise((resolve, reject) => {
        joi.validate(data, lib.Schemas.products.variant, (err, value) => {
          if (err) {
            return reject(new Errors.ValidationError(err))
          }
          return resolve(value)
    ...
    removeVariants(data) {
      return new Promise((resolve, reject) => {
        joi.validate(data, lib.Schemas.products.removeVariants, (err, value) => {
          if (err) {
            return reject(new Errors.ValidationError(err))
          }
          return resolve(value)
  ...
  validateImage: {
    ...
    remove(data) {
      return new Promise((resolve, reject) => {
        joi.validate(data, lib.Schemas.products.image, (err, value) => {
          if (err) {
            return reject(new Errors.ValidationError(err))
          }
          return resolve(value)
    ...
    removeImages(data) {
      return new Promise((resolve, reject) => {
        joi.validate(data, lib.Schemas.products.removeImages, (err, value) => {
          if (err) {
            return reject(new Errors.ValidationError(err))
          }
          return resolve(value)
  ...
  validateOrder: {
    ...
    pay(data) {
      return new Promise((resolve, reject) => {
        joi.validate(data, lib.Schemas.orders.pay, (err, value) => {
          if (err) {
            return reject(new Errors.ValidationError(err))
          }
          return resolve(value)
    ...
    refund(data) {
      return new Promise((resolve, reject) => {
        joi.validate(data, lib.Schemas.orders.refund, (err, value) => {
          if (err) {
            return reject(new Errors.ValidationError(err))
          }
          return resolve(value)
    ...
    capture(data) {
      return new Promise((resolve, reject) => {
        joi.validate(data, lib.Schemas.orders.capture, (err, value) => {
          if (err) {
            return reject(new Errors.ValidationError(err))
          }
          return resolve(value)
    ...
    void(data) {
      return new Promise((resolve, reject) => {
        joi.validate(data, lib.Schemas.orders.void, (err, value) => {
          if (err) {
            return reject(new Errors.ValidationError(err))
          }
          return resolve(value)
  ...
  validateCollection: {
    ...
    create(data) {
      return new Promise((resolve, reject) => {
        joi.validate(data, lib.Schemas.collections.collection, (err, value) => {
          if (err) {
            return reject(new Errors.ValidationError(err))
          }
          return resolve(value)

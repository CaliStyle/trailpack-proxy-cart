...
module.exports = [
  ...
  },
  {
    method: ['GET'],
    path: '/countries',
    handler: 'ProxyCartController.countries',
    config: {
      validate: {
        query: {
          offset: joi.number(),
  ...
  },
  {
    method: ['GET'],
    path: '/provinces',
    handler: 'ProxyCartController.provinces',
    config: {
      validate: {
        query: {
          offset: joi.number(),
  ...
  },
  {
    method: ['POST'],
    path: '/country',
    handler: 'ProxyCartController.createCountry',
    config: {
      app: {
        proxyRouter: {
          ignore: true
  ...
  },
  {
    method: ['GET'],
    path: '/country/:id',
    handler: 'ProxyCartController.country',
    config: {
      validate: {
        params: {
          id: joi.any()
  ...
  },
  {
    method: ['POST','PUT'],
    path: '/country/:id',
    handler: 'ProxyCartController.updateCountry',
    config: {
      validate: {
        params: {
          id: joi.any()
  ...
  },
  {
    method: ['DELETE'],
    path: '/country/:id',
    handler: 'ProxyCartController.destroyCountry',
    config: {
      validate: {
        params: {
          id: joi.any()
  ...
  },
  {
    ...
    handler: 'ProxyCartController.addProvince',
    config: {
      validate: {
        params: {
          id: joi.any(),
  ...
  },
  {
    ...
    handler: 'ProxyCartController.removeProvince',
    config: {
      validate: {
        params: {
          id: joi.any(),
  ...
  },
  {
    method: ['POST'],
    path: '/province',
    handler: 'ProxyCartController.createProvince',
    config: {
      app: {
        proxyRouter: {
          ignore: true
  ...
  },
  {
    method: ['GET'],
    path: '/province/:id',
    handler: 'ProxyCartController.province',
    config: {
      validate: {
        params: {
          id: joi.any()
  ...
  },
  {
    method: ['POST','PUT'],
    path: '/province/:id',
    handler: 'ProxyCartController.updateProvince',
    config: {
      validate: {
        params: {
          id: joi.any()
  ...
  },
  {
    method: ['DELETE'],
    path: '/province/:id',
    handler: 'ProxyCartController.destroyProvince',
    config: {
      validate: {
        params: {
          id: joi.any()

      ...
      options: {
        ...
        hooks: {
          beforeCreate: (values, options) => {
            return app.services.FulfillmentService.beforeCreate(values, options)
              .catch(err => {
                return Promise.reject(err)
              })
          },
          beforeUpdate: (values, options) => {
            return app.services.FulfillmentService.beforeUpdate(values, options)
              .catch(err => {
                return Promise.reject(err)
              })
          },
          afterCreate: (values, options) => {
            return app.services.FulfillmentService.afterCreate(values, options)
              .catch(err => {
                return Promise.reject(err)
              })
          },
          afterUpdate: (values, options) => {
            return app.services.FulfillmentService.afterUpdate(values, options)
              .catch(err => {
                return Promise.reject(err)
              })
          }
